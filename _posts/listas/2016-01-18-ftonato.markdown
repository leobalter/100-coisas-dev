...
28. [x] Concluir o mini-curso [Aprenda React na Prática](http://kodezilla.com/courses/introducao-ao-react).
29. [ ] Concluir o mini-curso [Python e Flask](http://www.alfamidiaonline.com.br/Turmas.aspx).
30. [x] Concluir o mini-curso [Visão Geral de ERP](http://www.alfamidiaonline.com.br/Turmas.aspx).
31. [x] Concluir o mini-curso [ReactJS Ninja](https://www.youtube.com/playlist?list=PLr4c053wuXU-mP3W_Z8EX_MLaHktns4jf).
...
43. [x] Concluir o mini-curso [Jogo de Aventura em JavaScript](http://www.alfamidiaonline.com.br/Turmas.aspx).
